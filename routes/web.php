...
//facebook
Route::get('/social-auth/{provider}', 'App\Http\Controllers\Auth\SocialController@redirectToProvider')->name('auth.social');
Route::get('/social-auth/{provider}/callback', 'App\Http\Controllers\Auth\SocialController@handleProviderCallback')->name('auth.social.callback');